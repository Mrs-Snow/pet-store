<template>
    <div>
        ...
        <a-modal v-model:visible="visible" title="商品管理" @ok="handleOk" ok-text="确认" cancel-text="取消">
            <Form>
                ...
                <FormItem label="图片:" help="展示图">
                    <a-upload v-model:file-list="fileList" name="file" action="" list-type="picture-card">
        ...
        <div class="searchButton">
            ...
            <Button style="position: absolute; left: 360px;" type="primary" danger @click="handleDelete"
        ...
        <Table :data-source="tableData" :columns="columns" :row-selection="rowSelection" :pagination="pagination"
            @change="handleTableChange" :row-key="record => { return record.id }">
    ...
    setup() {
        ...
        function reload() {
            ...
            request.post('/goods/getStoreGoods', {
                data: {
                    storeId: storeId, goodsName: searchForm.goodsName,
        ...
        return {
            load, tableData, columns, visible, handleAdd, rowSelection, preferentialOptions,
